...
!WRITE(*,*) "HRR_TRANSIENT",IX, IY, T, TOA
BURNING_TIME = T - TOA

! IF (BURNING_NODES%IFBFM .NE. 91) THEN
!    IF (BURNING_TIME .LT. ANALYSIS_CELLSIZE/MAX(1E-5, BURNING_NODES%VELOCITY_DMS_SURFACE)) THEN
!       HRR_PEAK = BURNING_NODES%FLIN_DMS_SURFACE / ANALYSIS_CELLSIZE
!       BURNING_NODES%HRR_TRANSIENT = HRR_PEAK
!       IF (BLDG_SPREAD_MODEL_TYPE .EQ. 2) HRR_TRANSIENT_MAP(IX,IY) = BURNING_NODES%HRR_TRANSIENT
!    ELSE
!       IF (BLDG_SPREAD_MODEL_TYPE .EQ. 2) HRR_TRANSIENT_MAP(IX,IY) = BURNING_NODES%HRR_TRANSIENT
!    ENDIF
