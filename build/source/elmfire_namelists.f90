...
DUMP_HPUA, DUMP_PHI, DUMP_REACTION_INTENSITY, DUMP_REAL_ESTATE_VALUE, &
...
DUMP_SPOTTING_OUTPUTS, RUN_ID, TIME_AT_BURNED_ACRES, USE_FOUR_DIGITS_IN_IWX_BAND, VIRTUAL_STATION_X, VIRTUAL_STATION_Y, &
DUMP_TOTAL_DFC_RECEIVED, DUMP_TOTAL_RAD_RECEIVED, DUMP_HRR_TRANSIENT, DUMP_FUEL_CONSUMPTION, &
DUMP_TRANSIENT_DFC, DUMP_TRANSIENT_RAD, DUMP_EMBER_FLUX_TRANSIENT, DUMP_EMBER_IGNITION
...
DUMP_EMBER_FLUX                   = .FALSE. ! Dump accumulated firebrand at each pixel
DUMP_SPOTTING_OUTPUTS             = .FALSE. ! In Langrangian mode, dump the source, target and releasing and ignition time of all particles
...
NAMELIST /WUI/ BLDG_AREA_CONSTANT, BLDG_NONBURNABLE_FRAC_CONSTANT, BLDG_SEPARATION_DIST_CONSTANT, &
               ...
               BANDTHICKNESS_WUI, CRITICL_HF_WUI, INTERFACE_MODEL_TYPE
...
SIGMA_CROSSWIND, MU_DOWNWIND, SIGMA_DOWNWIND, EMBER_GR_PER_MW_BLDG, EMBER_GR_PER_MW_VEGE, DIFF_WILDLAND_IGNITION
