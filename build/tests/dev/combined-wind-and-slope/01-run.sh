...
# Run name and paths
RUN_NAME="combined-wind-and-slope"     # Run name
...
NUM_FLOAT_RASTERS=7
FLOAT_RASTER[1]=ws   ; FLOAT_VAL[1]=22.3693629 # Wind speed (mph)
FLOAT_RASTER[2]=wd   ; FLOAT_VAL[2]=225.0 # Wind direction (deg)
...
NUM_INT_RASTERS=8
INT_RASTER[1]=slp     ; INT_VAL[1]=15     # Topographical slope (deg)
INT_RASTER[2]=asp     ; INT_VAL[2]=90     # Topographical aspect (deg)
