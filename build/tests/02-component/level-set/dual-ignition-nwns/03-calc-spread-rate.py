...
# --- Moisture inputs (fraction) ---
M = [0.03, 0.05, 0.06, 0.03, 0.30, 0.60]  # M1, M10, M100, dynamic dead, MLH, MLW
...
print(f"No-wind, no-slope ROS for FM10:")
