...
# Run name and paths
RUN_NAME="flat-terrain-with-wind"         # Run name
...
INT_RASTER[8]=cbh     ; INT_VAL[8]=20     # Canopy base height (10*m)
INT_RASTER[9]=cbd     ; INT_VAL[9]=15     # Canopy bulk density (100*kg/m3)
