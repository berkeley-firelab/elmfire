...
# Run Name: dual-ignition-with-wind
...
# Run name and paths
RUN_NAME="dual-ignition-with-wind"        # Run name
...
# Simulation timing
SIMULATION_TSTOP=14400.0                  # Simulation stop time (s)
DTDUMP=1200                               # Output dump interval (s)

# Fuel/Weather raster data
NUM_FLOAT_RASTERS=7
FLOAT_RASTER[1]=ws   ; FLOAT_VAL[1]=5.0   # Wind speed (mph)
