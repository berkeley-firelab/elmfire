...
FBFM_NW=3               # Fire behavior fuel model codes domain quads (-)
FBFM_NE=4
FBFM_SW=6
FBFM_SE=10
...
echo "Generating quadrant fuel model raster..."
python3 ./02-build-fbfm.py "$INPUTS/fbfm40.tif" "$DOMAINSIZE" "$CELLSIZE" "$FBFM_NW" "$FBFM_NE" "$FBFM_SW" "$FBFM_SE"
